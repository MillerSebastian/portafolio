...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      techNames: ['Vue', 'Tailwind', 'Firebase'],
    ...
    },
    {
      ...
      image: '/projects/img/ecomerse.png',
      technologies: [
        'https://cdn.simpleicons.org/react/61DAFB',
        'https://cdn.simpleicons.org/tailwindcss/38BDF8',
      ...
      techNames: [ 'React', 'Tailwind', 'Supabase', 'Google Cloud'],
      demoUrl: 'https://e-comerse-plantilla-phi.vercel.app/',
      repoUrl: 'https://github.com/MillerSebastian/E-comerse-plantilla',
    },
  ];
